...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Test the deployed Solar Panel Fault Detector')
    parser.add_argument('--model', type=str, default='deployment/model', help='Path to the model directory')
    parser.add_argument('--labels', type=str, default='deployment/label_mapping.json', help='Path to the label mapping file')
